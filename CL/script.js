...
const personas = [
  {
    nombre: "Juan Perez",
    edad: 18,
    correo: "cjpaye@gmail.com",
  },
  {
    nombre: "Maria Loza",
    edad: 21,
    correo: "carlospayebotero@gmail.com",
  },
];
...
function agregarPersona() {
  ...
  //Obtencion del elemento para mostrar error en el correo
  const msgErrorCorreo = document.querySelector("#msg-error-correo")
  //Se borra el contenido del elemento
  ...
  //Obtencion del input donde se ingresa el correo
  ...
  //Obtencion del valor del input + eliminacion de espacios del inicio y final
  ...
  function esEmailValido(correo){
    ...
    if(!esEmailValido(correo)){
        msgErrorCorreo.innerHTML = "Email invalido"
        hayError = true;
    }
  //Validacion del correo mediante funcion
  if(correo === ""){
  //Error de campo vacio
  msgErrorCorreo.innerHTML = "Debe ingresar email";
  hayError = true;
